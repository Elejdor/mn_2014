...
namespace simpson
{
    ...
    public class SimpsonIntegrator
    {
        ...
        public double Integrate(Func<double, double> f, double a, double b, double desiredRelativeError)
        {
        ...
        /// <returns>Integral value</returns>
        public double Integrate(Func<double, double> f, double a, double b, double relativeErrorTolerance, int log2MaxFunctionEvals, out int functionEvalsUsed, out double estimatedError)
        {
            double integral = 0.0;
